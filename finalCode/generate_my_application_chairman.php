...
$html_file=str_replace("{{To Role}}","Chairman", $html_file);
...
$output=$dompdf->output();
    ...
    $pname = rand(1000, 10000) . "-" . "my_noc_application_chairman.pdf";

$destdir='pdf/';

file_put_contents($destdir.$pname,$output);

$update_query="UPDATE `study_leave_application` SET `my_application_chairman` = '$pname' WHERE `study_leave_application`.`Leave_ID` = '$leave_id'";
