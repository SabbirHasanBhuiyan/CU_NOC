...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
        ...
        $mail_finding_query="SELECT Email from user where user_type='Registrar' ";
        ...
        $mail->Body="Hello Registrar CU, An Application for Study Leave is awaiting your primary approval. Please Visit NOC Website to send Your valuable Response. Thank You.";
        $mail->send();
