...
<body class="bg-gradient-to-r from-sky-200 to-black ">

<?php require 'navbar.php' ?>
<?php include 'checkProgressQuery.php'?>
<!-------------------------------progress Bar--------------------------------->
<div class=" mt-16 mx-auto mb-20 bg-sky-900 w-3/5 h-4/5 rounded-lg ">
  <div class=" grid place-content-start md:place-content-center">
    <ul class="steps">
      <li class="step <?php if($deptChairmain){?> step-info <?php } ?> font-serif  text-white">Department Chairman CU</li>
      <li class="step <?php if($registerPrimaryApproval){?> step-info <?php } ?> font-serif  text-white"> Register Primary Approval</li>
      <li class="step <?php if($higherStudyPrimaryApproval){?> step-info <?php } ?> font-serif  text-white">Higher Study Branch CU Primary Approval</li>
...
<!------------------------------Footer----------------------->
      <footer class="mt-20 footer items-center p-4 bg-gradient-to-r from-black to-blue-500 text-neutral-content" style="position:absolute;bottom:0;">
