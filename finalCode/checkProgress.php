...
<section class="">
  ...
  if($higherStudyBranchFinalApproval==2){
    ...
    echo '<div class="p-4 mb-4 text-sm text-green-600 rounded-lg bg-sky-100 dark:bg-gray-800 dark:text-blue-400" role="alert" ><div class="pl-80 ml-8">
    <span class="font-bold text-xl">Your Application is Approved.</span> 
    <a href="pdf/';
     echo $pname;
     echo '"><button type="button" class="text-white bg-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"><i class="fas fa-download"></i> Download Approval Letter </button></a></div>
  </div>';
  }
  ?>
  ...
  <div class="container mt-8 mb-12 px-5 py-24 mx-auto flex flex-wrap  bg-sky-50 h-5/10 w-2/5 rounded-lg drop-shadow-2xl">
    ...
    <div class="flex relative pb-8 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Registrar Primary Approval</h2>
        </div>
      </div>
    </div>
    ...
    <div class="flex relative pb-8 sm:items-center md:w-2/3 mx-auto">
      ...
      <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
        ...
        <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
          <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Registrar Secondary Approval</h2>
        </div>
      </div>
    </div>
