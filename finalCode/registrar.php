...
<div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
    <div>
      ...
      <?php foreach($newApplications as $newApplication){ ?>
          ...
          <a href="registrarConfirmation.php?id2=<?php echo $newApplication['Leave_ID']?>" class="block w-9/10 p-2 bg-gradient-to-r from-blue-500 to-black rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
