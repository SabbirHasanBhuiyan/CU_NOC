...
<head>
    ...
    <title>Welcome to CU NOC</title>
      <script src="https://cdn.tailwindcss.com"></script>
      <link href="https://cdn.jsdelivr.net/npm/daisyui@2.49.0/dist/full.css" rel="stylesheet" type="text/css" />
      <link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.6.3/flowbite.min.css"  rel="stylesheet" />
</head>
<body class="border-primary">
<!-- For Using navbar wriiten at another place -->
<?php require 'navbar.php' ?>
<?php require 'loginQuery.php' ?>

<header class=" ">
  <div class=" border-primary bg-gradient-to-r from-white to-blue-500 ms-auto flex flex-col justify-center items-center">
    <h2 class=" mx-auto mt-16 font-serif text-xl font-bold ">Study Leave Application System</h2>
    <div class="h-4/5 w-2/3 mb-16 shadow-2xl bg-gradient-to-r from-blue-300 to-white  flex flex-col justify-center items-center rounded my-5">
...
if ($showError==true)
 ...
 ?> 
  ...
  <!-- Dropdown menu -->
  <button id="dropdownRadioButton" data-dropdown-toggle="dropdownDefaultRadio" class=" order-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Role <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
  ...
  <ul class="p-3 space-y-3 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
    <li>
      <div class="flex items-center">
          <input checked id="default-radio-1" type="radio" value="" name="default-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
          <label for="default-radio-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Applicant</label>
      </div>
    </li>
    <li>
      <div class="flex items-center">
          ...
          <label for="default-radio-2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Evaluator</label>
      </div>
    </li>
  </ul>
</div>
...
<div class="text-xl font-medium text-gray-500 dark:text-gray-300 py-10">
